...
const prMsg = (msg) => {
    ...
    try {
        ...
        if (msg.key?.participant) {
            console.log(chalk.bold.blue("├─[") +
                chalk.bold.red("Participant") +
                chalk.bold.blue("] ") +
                chalk.yellow(msg.key.participant));
        }
        
        if (msg.key?.participantAlt) {
            console.log(chalk.bold.blue("├─[") +
                chalk.bold.red("ParticipantAlt") +
                chalk.bold.blue("] ") +
                chalk.magenta(msg.key.participantAlt));
        }
    
        if (msg.key?.addressingMode) {
            console.log(chalk.bold.blue("├─[") +
                chalk.bold.red("Addressing Mode") +
                chalk.bold.blue("] ") +
                chalk.yellow(msg.key.addressingMode));
        }
